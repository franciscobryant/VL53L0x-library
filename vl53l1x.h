...
enum DistanceMode { Short = 0, Medium = 1, Long = 2, Unknown = 3 };
...
//bool vl53l1x_init(bool io_2v8 = true);
...
//uint16_t vl53l1x_ read(bool blocking = true);
uint16_t vl53l1x_read(bool blocking);

//uint16_t vl53l1x_readRangeContinuousMillimeters(bool blocking = true) { return read(blocking); }; // alias of read()
uint16_t vl53l1x_readRangeContinuousMillimeters(bool blocking); // alias of read()
